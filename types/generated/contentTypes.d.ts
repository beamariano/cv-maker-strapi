...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bionote: Schema.Attribute.Blocks;
...
export interface ApiAwardAward extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_awarded: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event_details: Schema.Attribute.Component<'shared.event-details', false>;
...
export interface ApiPositionPosition extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Titles, Roles or Positions';
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    part_of_exhibit: Schema.Attribute.Relation<
      'manyToMany',
      'api::exhibit.exhibit'
    >;
    program_details: Schema.Attribute.Component<'shared.event-details', true>;
    publishedAt: Schema.Attribute.DateTime;
    time_end: Schema.Attribute.Time;
    time_start: Schema.Attribute.Time;
    under_project: Schema.Attribute.Relation<
      'manyToMany',
      'api::project.project'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTechProjectTechProject extends Struct.CollectionTypeSchema {
  collectionName: 'tech_projects';
  info: {
    displayName: 'Tech Projects';
    pluralName: 'tech-projects';
    singularName: 'tech-project';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tech-project.tech-project'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    notes: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
    repository_link: Schema.Attribute.String;
    tech: Schema.Attribute.Relation<'oneToMany', 'api::technology.technology'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTechnologyTechnology extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Technologies - Languages, Frameworks & Libraries';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    proficiency_level: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    tech_project: Schema.Attribute.Relation<
      'manyToOne',
      'api::tech-project.tech-project'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiWorkExperienceWorkExperience
  ...
  attributes: {
    ...
    engagement: Schema.Attribute.Enumeration<
      ['Full-time', 'Part-time', 'Project-Based', 'Volunteer']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    Notes: Schema.Attribute.Blocks;
    ongoing: Schema.Attribute.Boolean;
    publishedAt: Schema.Attribute.DateTime;
    reponsibilities: Schema.Attribute.Blocks;
    titles_positions_or_roles: Schema.Attribute.Relation<
      'manyToMany',
      'api::position.position'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    control_no: Schema.Attribute.UID;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    depth_cm: Schema.Attribute.Decimal;
    description: Schema.Attribute.String;
    duration: Schema.Attribute.String;
    durational: Schema.Attribute.Boolean;
    edition: Schema.Attribute.String;
    features_and_reviews: Schema.Attribute.Relation<
      'manyToMany',
      'api::feature.feature'
    >;
    form: Schema.Attribute.Enumeration<
      ['painting', 'drawing', 'print', 'sculpture', 'film / video', 'new media']
    >;
    frame_depth_cm: Schema.Attribute.Decimal;
    frame_height_cm: Schema.Attribute.Decimal;
    frame_width_cm: Schema.Attribute.Decimal;
    framed: Schema.Attribute.Boolean;
    height_cm: Schema.Attribute.Decimal;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::work.work'> &
      Schema.Attribute.Private;
    markings: Schema.Attribute.Blocks;
    media_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::media-category.media-category'
    >;
    ...
    signature_location: Schema.Attribute.Enumeration<
      [
        'top left',
        'top center',
        'top right',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    width_cm: Schema.Attribute.Decimal;
  };
}

export interface ApiWorkshopFellowshipWorkshopFellowship
  extends Struct.CollectionTypeSchema {
  collectionName: 'workshops_fellowships';
  info: {
    displayName: 'Workshops & Fellowships';
    pluralName: 'workshops-fellowships';
    singularName: 'workshop-fellowship';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event_details: Schema.Attribute.Component<'shared.event-details', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::workshop-fellowship.workshop-fellowship'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::tech-project.tech-project': ApiTechProjectTechProject;
      'api::technology.technology': ApiTechnologyTechnology;
      'api::work-experience.work-experience': ApiWorkExperienceWorkExperience;
      'api::work.work': ApiWorkWork;
      'api::workshop-fellowship.workshop-fellowship': ApiWorkshopFellowshipWorkshopFellowship;
